...
if($halaman_aktif > 1){
	$prev = $halaman_aktif-1;
	$link_halaman .= "<li><a href='".BASE_URL."/kategori/$_GET[kategori_seo]/page/$prev'>&laquo; Prev</a></li> ";
}
else{ 
	$link_halaman .= "<li><a href='#'>&laquo; Prev</a></li>";
}
...
for ($i=$halaman_aktif-2; $i<$halaman_aktif; $i++){
  if ($i < 1)
  	continue;
	  $angka .= "<li><a href='".BASE_URL."/kategori/$_GET[kategori_seo]/page/$i'>$i</a></li>";
  }
    ...
    if($i > $jmlhalaman)
	  ...
	  $angka .= ($halaman_aktif+2<$jmlhalaman ? " ... <li><a href='".BASE_URL."/kategori/$_GET[kategori_seo]/page/$jmlhalaman'>$jmlhalaman</a></li> " : " ");
...
if($halaman_aktif < $jmlhalaman){
	$next = $halaman_aktif+1;
	$link_halaman .= " <li><a href='".BASE_URL."/kategori/$_GET[kategori_seo]/page/$next'>Next &raquo;</a></li> ";
}
else{
	$link_halaman .= " <li><a href='#'>Next &raquo;</a></li>";
}
return $link_halaman;
}
}
