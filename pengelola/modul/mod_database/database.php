                ...
                <div class='col-md-12'>
                    <div class='panel panel-default'>
                        <div class='panel-body'>";
							if(file_exists("../personal.zip"))
							{echo"<button type=\"button\" class=\"btn btn-info\" onclick=\"window.location.href='dl.php?file=personal.zip'\">
                                    ...
                                    <tbody>
											...
											<tr>
												...
												<td style='text-align:center'>
                                                    <a class='btn btn-success square-btn-adjust' href='media.php?modul=database&act=restore&file=$file' id=\"db_restore\"><i class='fa fa-upload'></i> Restore</a>
