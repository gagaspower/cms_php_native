...
$query = mysql_query("SELECT berita.id, 
                             ...
                             LEFT JOIN users ON users.id = berita.user_id
...
?> 
                <div class="col-md-4 col-sm-6">
                    <div class="thumbnail">
                        <a href="<?php echo $id['url_website'];?>/blog/detail/<?php echo $r['judul_seo'];?>/">
                        ...
                        <div class="caption">
                            <h1><a href="<?php echo $id['url_website'];?>/blog/detail/<?php echo $r['judul_seo'];?>/"><?php echo $r['judul'];?></a></h1>
                            <p class="by-author">
                            ...
                            <p>
                                <a href="<?php echo $id['url_website'];?>/blog/detail/<?php echo $r['judul_seo'];?>/" class="btn btn-primary btn-sm" role="button">Selengkapnya <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
                            </p>
                        </div>
                    </div>
                </div>
<?php } } ?>
        ...
        <div class="col-md-12">
            <div class="thumbnail">
                <center><button type="button" class="btn btn-info btn-sm" onclick="window.location.href='<?php echo BASE_URL;?>/blog'"><i class="fa fa-rocket"></i>&nbsp;<strong>Semua Artikel</strong></button> </center>
            </div>
        </div>
</section>
<!-- LATEST BLOG SELESAI -->
