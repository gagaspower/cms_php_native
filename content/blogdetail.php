    ...
    ?>
        <div class="col-md-6">
            <ul class="media-list main-list">
                <li class="media">
                    <a class="pull-left" href="<?php echo BASE_URL;?>/blog/detail/<?php echo $h['judul_seo'];?>/">
                    ...
                    <div class="media-body">
                        <h4><a href="<?php echo BASE_URL;?>/blog/detail/<?php echo $h['judul_seo'];?>/"><?php echo $h['judul'];?></a></h4>
